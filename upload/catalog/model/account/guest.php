...
class ModelAccountGuest extends Model {
	public function getOrder($order_id, $email) {
		$order_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "order` WHERE order_id = '" . (int)$order_id . "' AND LOWER(email) = '" . $email . "' AND order_status_id > '0'");
		//echo "SELECT * FROM `" . DB_PREFIX . "order` WHERE order_id = '" . (int)$order_id . "' AND LOWER(email) = '" . $email . "' AND customer_id != '0' AND order_status_id > '0'";
